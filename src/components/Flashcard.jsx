      ...
      {timer ? (
        <div id="timesUp">
          <div id="timeout-view">
            <h4>Time's up!</h4>
            <h4>{(score / 25) * 100}%</h4>
            <button onClick={() => handleResultData(userName, (score / 25) * 100, currentFlashcard.topic)}>Submit</button>
          </div>
        </div>
      ) : !currentFlashcard ? (
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    <td><h4>{25}</h4></td>
                    <td><h4>{score}</h4></td>
                    <td><h4>{25 - score}</h4></td>
                    <td><h4>{(score / 25) * 100}%</h4></td>
                    <td><button onClick={() => handleResultData(userName, (score / 25) * 100, currentFlashcard.topic)}>Exit</button></td>
                  </tr>
                </tbody>
              </table>
            </div>
